...
function Pagination({ count }) {
  ...
  // in the first render, page = null => currentPage = 1 => then the next will be calculated by plusing 1 to the currentPage => update the currentPage using setSearchParams.set("page", next)
  ...
  if (pageCount === 1) return null; // if there is only one page => not show <Pagination/> component
