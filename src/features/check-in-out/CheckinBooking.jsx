...
function CheckinBooking() {
  ...
  const { settingsData, isPending: isPendingSettings } = useSettings();
  ...
  const { id: bookingId, guests, extrasPrice, totalPrice, numGuests, hasBreakfast, numNights } = booking;
  ...
  return (
    <>
      ...
      <ButtonGroup>
        <Button $variation="primary" size="medium" onClick={handleCheckin} disabled={!confirmPaid || isCheckingIn}>
